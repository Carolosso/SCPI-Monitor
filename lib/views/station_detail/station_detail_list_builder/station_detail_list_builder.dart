...
import 'package:test/views/station_detail/station_detail_list_builder/station_detail_items/power_supply/station_detail_generator.dart';
                ...
                itemBuilder: (context, indexDevice) {
                  ...
                  if (viewModel
                    ...
                    return Dismissible(
                        ...
                        child: StationDetailItemPowerSupply(
                            viewModel: viewModel,
                            indexStation: indexStation,
                            indexDevice: indexDevice,
                            nameTextController: nameTextController));
