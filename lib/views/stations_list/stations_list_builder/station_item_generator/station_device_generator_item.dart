...
import 'package:test/views/stations_list/stations_list_builder/station_item_generator/item_channel_builder.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                itemChannelBuilder(1),
                const SizedBox(
                  width: 6,
                ),
                itemChannelBuilder(2)
              ],
            ),
          ],
        ),
